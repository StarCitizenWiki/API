...
use App\Http\Controllers\Web\StarCitizen\Vehicle\Ship\ShipController;
...
class ShipControllerTestCase extends StarCitizenTestCase
{
     ...
     * Test Index
     *
     * @covers \App\Http\Controllers\Web\StarCitizen\Vehicle\Ship\ShipController::index
     * @covers \App\Http\Controllers\Api\V1\StarCitizen\Vehicle\VehicleController
     */
    public function testIndex()
    {
        $response = $this->actingAs($this->user)->get(route('web.starcitizen.vehicles.ships.index'));
        $response->assertStatus(static::RESPONSE_STATUSES['index']);

        if ($response->status() === Response::HTTP_OK) {
            $response->assertViewIs('web.starcitizen.vehicles.ships.index')
     ...
     * Test Edit
     *
     * @covers \App\Http\Controllers\Web\StarCitizen\Vehicle\Ship\ShipController::edit
     * @covers \App\Http\Controllers\Api\V1\StarCitizen\Vehicle\VehicleController
     */
    public function testEdit()
    {
        ...
        $response = $this->actingAs($this->user)->get(
            route('web.starcitizen.vehicles.ships.edit', $ship->getRouteKey())
        );
        $response->assertStatus(static::RESPONSE_STATUSES['edit']);

        if ($response->status() === Response::HTTP_OK) {
            $response->assertViewIs('web.starcitizen.vehicles.ships.edit')
    ...
    {
        $response = $this->actingAs($this->user)->get(
            route('web.starcitizen.vehicles.ships.edit', static::MODEL_ID_NOT_EXISTENT)
        );
     ...
     * Test Update
     *
     * @covers \App\Http\Controllers\Web\StarCitizen\Vehicle\Ship\ShipController::update
     * @covers \App\Http\Controllers\Api\V1\StarCitizen\Vehicle\VehicleController
     *
    ...
    public function testUpdate()
    {
        ...
        $response = $this->actingAs($this->user)->patch(
            route('web.starcitizen.vehicles.ships.update', $ship->getRouteKey()),
            [
    ...
    public function testUpdateNotFound()
    {
        ...
        $response = $this->actingAs($this->user)->patch(
            route('web.starcitizen.vehicles.ships.update', static::MODEL_ID_NOT_EXISTENT),
            [
                'en_EN' => 'GroundVehicle translation',
                'de_DE' => 'Translation Deutsch',
            ]
