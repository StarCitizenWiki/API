...
class CommLinkControllerTestCase extends UserTestCase
{
    ...
    /**
     * @covers \App\Http\Controllers\Web\Rsi\CommLink\CommLinkController::index
     * @covers \App\Policies\Web\Rsi\CommLink\CommLinkPolicy::view
     */
    ...
    /**
     * @covers \App\Http\Controllers\Web\Rsi\CommLink\CommLinkController::show
     * @covers \App\Policies\Web\Rsi\CommLink\CommLinkPolicy::view
     */
    public function testShow(): void
    {
        $response = $this->actingAs($this->user)->get(
            route('web.rsi.comm-links.show', $this->commLink->getRouteKey())
        );
        ...
        if (Response::HTTP_OK === $response->status()) {
            ...
            if ($this->user->can('web.rsi.comm-links.update')) {
...
EOF
        ...
        $response = $this->actingAs($this->user)->get(
            route('web.rsi.comm-links.edit', $this->commLink->getRouteKey())
        );
    ...
    public function testUpdate(): void
    {
        $response = $this->actingAs($this->user)->patch(
            route('web.rsi.comm-links.update', $this->commLink),
            [
...
EOF
        ...
        $response = $this->actingAs($this->user)->get(
            route('web.rsi.comm-links.preview', [$this->commLink, $version])
        );
