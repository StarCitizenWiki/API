...
class ParseVehicleTest extends TestCase
{
     ...
     * @covers \App\Jobs\Api\StarCitizen\Vehicle\Parser\Element\Component
     * @covers \App\Jobs\Api\StarCitizen\Vehicle\Parser\Element\AbstractBaseElement
     */
    public function testParsing()
    {
        $parser = new ParseVehicle(
            new Collection(json_decode(File::get(resource_path('test_files/shipmatrix/aurora_es.json'))))
        );
        $parser->handle();
