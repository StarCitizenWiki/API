...
#[CacheTag('vehicles')]
class CacheTaggedControllerForCacheTagsStub
{
    public function __invoke(): void {}
}

class UntaggedControllerForCacheTagsStub
{
    public function __invoke(): void {}
}
...
describe('AddCloudflareCacheTags middleware', function (): void {
    it('sets scoped cache tags from controller attributes', function (string $path, string $expectedHeader): void {
        $response = handleCacheTagRequest($path, CacheTaggedControllerForCacheTagsStub::class);
    ...
    it('appends default version cache tags', function (): void {
        $request = cacheTagRequest('/api/vehicles', CacheTaggedControllerForCacheTagsStub::class);
    ...
    it('does not set cache tags for unsafe methods, closure routes, or untagged controllers', function (Request $request): void {
        ...
        'unsafe method' => fn (): Request => cacheTagRequest('/api/vehicles', CacheTaggedControllerForCacheTagsStub::class, 'POST'),
        'closure route' => fn (): Request => closureRouteCacheTagRequest('/api/openapi'),
        'untagged controller' => fn (): Request => cacheTagRequest('/admin', UntaggedControllerForCacheTagsStub::class),
    ]);
});
