...
@section('content')
    <div class="d-flex mb-3 nav-bar">
        @unless(null === $prev)
            <a href="{{ route('web.rsi.comm-links.show', $prev) }}" class="btn btn-outline-secondary">@lang('Vorheriger')</a>
        @else
            <a href="#" class="btn btn-outline-secondary disabled">@lang('Vorheriger')</a>
        @endunless
        @unless(null === $next)
            <a href="{{ route('web.rsi.comm-links.show', $next) }}" class="btn btn-outline-secondary ml-auto">@lang('Nächster')</a>
        @else
                ...
                <div class="col-12 col-xl-8">
                    <nav class="mb-3">
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            ...
                            @can('web.rsi.comm-links.update')
                                <a class="nav-item nav-link" aria-selected="false" href="{{ route('web.rsi.comm-links.edit', $commLink->getRouteKey()) }}">
                    ...
                    <div class="tab-content" id="nav-tab-translations">
                        ...
                        <div class="tab-pane fade" id="changelog" role="tabpanel" aria-labelledby="nav-changelog-tab">
                            @component('components.changelog_list', [
                ...
                <div class="col-12 col-xl-4 mt-xl-0 mt-5">
                    <table class="table mb-0 table-responsive">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('web.rsi.comm-links.categories.show', $commLink->category->getRouteKey()) }}">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('web.rsi.comm-links.channels.show', $commLink->channel->getRouteKey()) }}">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('web.rsi.comm-links.series.show', $commLink->series->getRouteKey()) }}">
