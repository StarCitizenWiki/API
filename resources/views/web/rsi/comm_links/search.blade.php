...
@section('content')
    ...
    <div class="card-deck">
        <div class="card mb-3">
            ...
            <div class="card-body">
                @component('components.forms.form', [
                    'action' => route('web.rsi.comm-links.reverse-image-link-search.post'),
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                @component('components.forms.form', [
                    'action' => route('web.rsi.comm-links.reverse-image-search.post'),
                    'class' => 'd-flex h-100 flex-column',
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                @component('components.forms.form', [
                    'action' => route('web.rsi.comm-links.images.search'),
                    'class' => 'd-flex h-100 flex-column',
                ])
                    @component('components.forms.form-group', [
                        'inputType' => 'text',
