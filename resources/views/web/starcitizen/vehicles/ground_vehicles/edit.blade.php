...
@section('content')
    <div class="row">
        <div class="col-12 col-xl-6">
            ...
            <div class="card">
                ...
                <div class="card-body collapse" id="components">
                    @include('components.vehicle_components', ['componentGroups' => $componentGroups])
                </div>
            </div>
        </div>
        ...
        <div class="col-12 col-xl-6">
            @component('components.forms.form', [
                'action' => route('web.starcitizen.vehicles.ground-vehicles.update', $groundVehicle->getRouteKey()),
                'method' => 'PATCH',
                'class' => 'card'
            ])
                <div class="wrapper">
