    ...
    @component('components.forms.form', [
        ...
        <div class="wrapper">
            ...
            <div class="card-footer d-flex">
                @if($user->trashed())
                    <button class="btn btn-outline-warning" id="restore" name="restore">@lang('Wiederherstellen')</button>
                @else
                    <button class="btn btn-outline-danger" id="delete" name="delete">@lang('Löschen')</button>
                @endif
