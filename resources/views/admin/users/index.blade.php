                        ...
                        <td>
                            @unless($user->id === Auth::id())
                                ...
                                <dialog id="deleteModal{{ $user->id }}" class="modal"
                                        data-testid="admin-users-delete-modal-{{ $user->id }}">
                                    <div class="modal-box">
                                        <h3 class="text-lg font-semibold">Confirm Deletion</h3>
                                        <p class="py-4">Are you sure you want to delete user "{{ $user->name }}"? This
                                        ...
                                        <div class="modal-action">
                                            ...
                                            <button class="btn" onclick="deleteModal{{ $user->id }}.close()">Cancel
                                            </button>
                                        </div>
                                    </div>
                                </dialog>
