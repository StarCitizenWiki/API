...
<div {{ $attributes->merge(['class' => 'card border border-base-300 bg-base-100 shadow'])}}>
    <div class="card-body gap-4">
        ...
        <dl class="grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
            <div class="space-y-1">
                <dt class="text-xs font-medium uppercase tracking-wide text-muted">Laser Power</dt>
                <dd class="text-sm font-semibold text-base-content">{{ fmt_range($laserPowerMin, $laserPowerMax, '') }}</dd>
            </div>

            <div class="space-y-1">
                <dt class="text-xs font-medium uppercase tracking-wide text-muted">Module Slots</dt>
                ...
                <summary class="flex cursor-pointer items-center gap-2 py-2 text-sm font-semibold text-subtle list-none [&::-webkit-details-marker]:hidden">
                    ...
                    <dl class="grid gap-3 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 pt-1 pb-2">
                        @if ($optimalRange !== null)
                            <div class="space-y-1">
                                <dt class="text-xs font-medium uppercase tracking-wide text-muted">Optimal Range</dt>
                        ...
                        @if ($maximumRange !== null)
                            <div class="space-y-1">
                                <dt class="text-xs font-medium uppercase tracking-wide text-muted">Maximum Range</dt>
                        ...
                        @if ($throttleLerpSpeed !== null)
                            <div class="space-y-1">
                                <dt class="text-xs font-medium uppercase tracking-wide text-muted">Throttle Lerp Speed</dt>
                        ...
                        @if ($throttleMinimum !== null)
                            <div class="space-y-1">
                                <dt class="text-xs font-medium uppercase tracking-wide text-muted">Throttle Minimum</dt>
