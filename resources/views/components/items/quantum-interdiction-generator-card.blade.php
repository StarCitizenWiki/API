...
<div {{ $attributes->merge(['class' => 'card border border-base-300 bg-base-100 shadow'])}}>
    <div class="card-body gap-4">
        ...
        <dl class="grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
            <div class="space-y-1">
                <dt class="text-xs font-medium uppercase tracking-wide text-base-content/45">Jamming Range</dt>
                <dd class="text-sm font-medium">{{ fmt_value_with_unit(data_get($jamming, 'range'), 'm', 0) }}</dd>
            </div>

            <div class="space-y-1 col-span-2">
                <dt class="text-xs font-medium uppercase tracking-wide text-base-content/45">Pulse Radius</dt>
            ...
            <div class="space-y-1">
                <dt class="text-xs font-medium uppercase tracking-wide text-base-content/45">Discharge Time</dt>
                ...
                <summary class="flex cursor-pointer items-center gap-2 py-2 text-sm font-semibold text-base-content/70 list-none [&::-webkit-details-marker]:hidden">
                    ...
                    <dl class="grid gap-3 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 pt-1 pb-2">
                        @if ($hasPowerFractions)
                            <div class="space-y-1">
                                <dt class="text-xs font-medium uppercase tracking-wide text-base-content/45">Base Power Fraction</dt>
                                <dd class="text-sm font-medium">{{ fmt_value_with_unit(data_get($powerFractions, 'base'), '', 2) }}</dd>
                            </div>

                            <div class="space-y-1">
                                <dt class="text-xs font-medium uppercase tracking-wide text-base-content/45">Pulse Power Fraction</dt>
                                <dd class="text-sm font-medium">{{ fmt_value_with_unit(data_get($powerFractions, 'pulse'), '', 2) }}</dd>
                            </div>

                            <div class="space-y-1">
                                <dt class="text-xs font-medium uppercase tracking-wide text-base-content/45">Jammer Power Fraction</dt>
                        ...
                        @if ($hasJamming)
                            @if (data_get($jamming, 'green_zone_check_range') !== null)
                                <div class="space-y-1">
                                    <dt class="text-xs font-medium uppercase tracking-wide text-base-content/45">Jamming Green Zone Check Range</dt>
                        ...
                        @if ($hasPulse)
                            @if (data_get($pulse, 'activation_phase_duration') !== null)
                                <div class="space-y-1">
                                    <dt class="text-xs font-medium uppercase tracking-wide text-base-content/45">Activation Phase Duration</dt>
                            ...
                            @if (data_get($pulse, 'disperse_charge_time') !== null)
                                <div class="space-y-1">
                                    <dt class="text-xs font-medium uppercase tracking-wide text-base-content/45">Disperse Charge Time</dt>
                            ...
                            @if (data_get($pulse, 'decrease_charge_rate_time') !== null)
                                <div class="space-y-1">
                                    <dt class="text-xs font-medium uppercase tracking-wide text-base-content/45">Decrease Charge Rate Time</dt>
                            ...
                            @if (data_get($pulse, 'increase_charge_rate_time') !== null)
                                <div class="space-y-1">
                                    <dt class="text-xs font-medium uppercase tracking-wide text-base-content/45">Increase Charge Rate Time</dt>
                        ...
                        @endif
                            ...
                            <div class="space-y-1">
                                <dt class="text-xs font-medium uppercase tracking-wide text-base-content/45">Jamming Max Power Draw</dt>
                                <dd class="text-sm font-medium">{{ fmt_value_with_unit(data_get($jamming, 'max_power_draw'), '', 2) }}</dd>
                            </div>

                            <div class="space-y-1">
                                <dt class="text-xs font-medium uppercase tracking-wide text-base-content/45">Pulse Max Power Draw</dt>
                    ...
                    <summary class="flex cursor-pointer items-center gap-2 py-2 text-sm font-semibold text-base-content/70 list-none [&::-webkit-details-marker]:hidden">
                        ...
                        <dl class="grid gap-3 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 pt-1 pb-2">
                            @if (data_get($pulse, 'stop_charging_power_fraction') !== null)
                                <div class="space-y-1">
                                    <dt class="text-xs font-medium uppercase tracking-wide text-base-content/45">Stop Charging Power Fraction</dt>
                            ...
                            @if (data_get($pulse, 'max_charge_rate_power_fraction') !== null)
                                <div class="space-y-1">
                                    <dt class="text-xs font-medium uppercase tracking-wide text-base-content/45">Max Charge Rate Power Fraction</dt>
                            ...
                            @if (data_get($pulse, 'active_power_fraction') !== null)
                                <div class="space-y-1">
                                    <dt class="text-xs font-medium uppercase tracking-wide text-base-content/45">Active Power Fraction</dt>
                            ...
                            @if (data_get($pulse, 'tethering_power_fraction') !== null)
                                <div class="space-y-1">
                                    <dt class="text-xs font-medium uppercase tracking-wide text-base-content/45">Tethering Power Fraction</dt>
                            ...
                            @if (data_get($pulse, 'green_zone_check_range') !== null)
                                <div class="space-y-1">
                                    <dt class="text-xs font-medium uppercase tracking-wide text-base-content/45">Pulse Green Zone Check Range</dt>
