...
<div {{ $attributes->merge(['class' => 'card border border-base-300 bg-base-100 shadow'])}}>
    <div class="card-body gap-4">
        ...
        <dl class="grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
            <div class="space-y-1">
                <dt class="text-xs font-medium uppercase tracking-wide text-base-content/45">Force</dt>
            ...
            @if ($forceMaxVolume !== null)
                <div class="space-y-1">
                    <dt class="text-xs font-medium uppercase tracking-wide text-base-content/45">Max Volume</dt>
                ...
                <summary class="flex cursor-pointer items-center gap-2 py-2 text-sm font-semibold text-base-content/70 list-none [&::-webkit-details-marker]:hidden">
                    ...
                    <dl class="grid gap-3 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 pt-1 pb-2">
                        ...
                        @if ($towingMaxAccel !== null)
                            <div class="space-y-1">
                                <dt class="text-xs font-medium uppercase tracking-wide text-base-content/45">Max Acceleration</dt>
                        ...
                        @if ($towingQtMassLimit !== null)
                            <div class="space-y-1">
                                <dt class="text-xs font-medium uppercase tracking-wide text-base-content/45">QT Mass Limit</dt>
                ...
                <summary class="flex cursor-pointer items-center gap-2 py-2 text-sm font-semibold text-base-content/70 list-none [&::-webkit-details-marker]:hidden">
                    ...
                    <dl class="grid gap-3 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 pt-1 pb-2">
                        ...
                        @if ($tetherAllowScrolling !== null)
                            <div class="space-y-1">
                                <dt class="text-xs font-medium uppercase tracking-wide text-base-content/45">Allow Scrolling Into Breaking Range</dt>
                    ...
                    @if ($hasCargo)
                        <dl class="mb-4 grid gap-3 grid-cols-2 sm:grid-cols-2 pt-1 pb-2">
                            @if ($cargoMinForce !== null)
                                <div class="space-y-1">
                                    <dt class="text-xs font-medium uppercase tracking-wide text-base-content/45">Min Force</dt>
                                    <dd class="text-sm font-semibold text-base-content">{{ fmt_value_with_unit($cargoMinForce, 'N', 2) }}</dd>
                                </div>
                            @endif
                            @if ($cargoMaxForce !== null)
                                <div class="space-y-1">
                                    <dt class="text-xs font-medium uppercase tracking-wide text-base-content/45">Max Force</dt>
                                    <dd class="text-sm font-semibold text-base-content">{{ fmt_value_with_unit($cargoMaxForce, 'N', 2) }}</dd>
                                </div>
                            @endif
                            @if ($cargoMinAccel !== null)
                                <div class="space-y-1">
                                    <dt class="text-xs font-medium uppercase tracking-wide text-base-content/45">Min Acceleration</dt>
                            ...
                            @if ($cargoMinSpeed !== null)
                                <div class="space-y-1">
                                    <dt class="text-xs font-medium uppercase tracking-wide text-base-content/45">Min Speed</dt>
                            ...
                            @if ($cargoAccelFactor !== null)
                                <div class="space-y-1">
                                    <dt class="text-xs font-medium uppercase tracking-wide text-base-content/45">Acceleration Factor</dt>
                                    <dd class="text-sm font-semibold text-base-content">{{ fmt_value_with_unit($cargoAccelFactor, '', 2) }}</dd>
                                </div>
                            @endif
                            @if ($cargoDegreesPerAction !== null)
                                <div class="space-y-1">
                                    <dt class="text-xs font-medium uppercase tracking-wide text-base-content/45">Degrees Per Action</dt>
                            ...
                            @if ($cargoDegreesScrollWheel !== null)
                                <div class="space-y-1">
                                    <dt class="text-xs font-medium uppercase tracking-wide text-base-content/45">Degrees Per Action Scroll Wheel</dt>
                            ...
                            @if ($cargoForceFractionRot !== null)
                                <div class="space-y-1">
                                    <dt class="text-xs font-medium uppercase tracking-wide text-base-content/45">Force Fraction Rotation</dt>
