    ...
    <div class="card-body gap-4">
        ...
        <dl class="grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
            <div class="space-y-1">
                ...
                <dd class="text-sm font-semibold text-base-content">{{ fmt_value_with_unit($cooldown, 's', 2) }}</dd>
            </div>
        </dl>
                    ...
                    <dl class="grid gap-3 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 pt-1 pb-2">
                        @if ($sensIr !== null)
                            <div class="space-y-1">
                                ...
                                <dd class="text-sm font-semibold text-base-content">{{ fmt_or_dash($sensIr, 2) }}</dd>
                            </div>
                        @endif
                        @if ($sensCs !== null)
                            <div class="space-y-1">
                                <dt class="text-xs font-medium uppercase tracking-wide text-muted">Cross Section</dt>
                                <dd class="text-sm font-semibold text-base-content">{{ fmt_or_dash($sensCs, 2) }}</dd>
                            </div>
                        @endif
                        @if ($sensEm !== null)
                            <div class="space-y-1">
                                <dt class="text-xs font-medium uppercase tracking-wide text-muted">Electromagnetic</dt>
                                <dd class="text-sm font-semibold text-base-content">{{ fmt_or_dash($sensEm, 2) }}</dd>
                            </div>
                        @endif
                        @if ($sensResource !== null)
                            <div class="space-y-1">
                                <dt class="text-xs font-medium uppercase tracking-wide text-muted">Resource</dt>
                                <dd class="text-sm font-semibold text-base-content">{{ fmt_or_dash($sensResource, 2) }}</dd>
                            </div>
                        @endif
                        @if ($sensDb !== null)
                            <div class="space-y-1">
                                <dt class="text-xs font-medium uppercase tracking-wide text-muted">dB</dt>
                                <dd class="text-sm font-semibold text-base-content">{{ fmt_or_dash($sensDb, 2) }}</dd>
                            </div>
                        @endif
                    </dl>
            </details>
                ...
                <summary class="flex cursor-pointer items-center gap-2 py-2 text-sm font-semibold text-subtle list-none [&::-webkit-details-marker]:hidden">
                    ...
                    <dl class="grid gap-3 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 pt-1 pb-2">
                        @if ($gvsIr !== null)
                            <div class="space-y-1">
                                <dt class="text-xs font-medium uppercase tracking-wide text-muted">Infrared</dt>
                                <dd class="text-sm font-semibold text-base-content">{{ fmt_or_dash($gvsIr, 2) }}</dd>
                            </div>
                        @endif
                        @if ($gvsCs !== null)
                            <div class="space-y-1">
                                <dt class="text-xs font-medium uppercase tracking-wide text-muted">Cross Section</dt>
                                <dd class="text-sm font-semibold text-base-content">{{ fmt_or_dash($gvsCs, 2) }}</dd>
                            </div>
                        @endif
                        @if ($gvsEm !== null)
                            <div class="space-y-1">
                                <dt class="text-xs font-medium uppercase tracking-wide text-muted">Electromagnetic</dt>
                                <dd class="text-sm font-semibold text-base-content">{{ fmt_or_dash($gvsEm, 2) }}</dd>
                            </div>
                        @endif
                        @if ($gvsResource !== null)
                            <div class="space-y-1">
                                <dt class="text-xs font-medium uppercase tracking-wide text-muted">Resource</dt>
                                <dd class="text-sm font-semibold text-base-content">{{ fmt_or_dash($gvsResource, 2) }}</dd>
                            </div>
                        @endif
                        @if ($gvsDb !== null)
                            <div class="space-y-1">
                                <dt class="text-xs font-medium uppercase tracking-wide text-muted">dB</dt>
                                <dd class="text-sm font-semibold text-base-content">{{ fmt_or_dash($gvsDb, 2) }}</dd>
                            </div>
                        @endif
                    </dl>
            </details>
                ...
                <summary class="flex cursor-pointer items-center gap-2 py-2 text-sm font-semibold text-subtle list-none [&::-webkit-details-marker]:hidden">
                    ...
                    <dl class="grid gap-3 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 pt-1 pb-2">
                        @if ($pierceIr !== null)
                            <div class="space-y-1">
                                <dt class="text-xs font-medium uppercase tracking-wide text-muted">Infrared</dt>
                                <dd class="text-sm font-semibold text-base-content">{{ fmt_or_dash($pierceIr, 2) }}</dd>
                            </div>
                        @endif
                        @if ($pierceCs !== null)
                            <div class="space-y-1">
                                <dt class="text-xs font-medium uppercase tracking-wide text-muted">Cross Section</dt>
                                <dd class="text-sm font-semibold text-base-content">{{ fmt_or_dash($pierceCs, 2) }}</dd>
                            </div>
                        @endif
                        @if ($pierceEm !== null)
                            <div class="space-y-1">
                                <dt class="text-xs font-medium uppercase tracking-wide text-muted">Electromagnetic</dt>
                                <dd class="text-sm font-semibold text-base-content">{{ fmt_or_dash($pierceEm, 2) }}</dd>
                            </div>
                        @endif
                        @if ($pierceResource !== null)
                            <div class="space-y-1">
                                <dt class="text-xs font-medium uppercase tracking-wide text-muted">Resource</dt>
                                <dd class="text-sm font-semibold text-base-content">{{ fmt_or_dash($pierceResource, 2) }}</dd>
                            </div>
                        @endif
                        @if ($pierceDb !== null)
                            <div class="space-y-1">
                                <dt class="text-xs font-medium uppercase tracking-wide text-muted">dB</dt>
                                <dd class="text-sm font-semibold text-base-content">{{ fmt_or_dash($pierceDb, 2) }}</dd>
                            </div>
                        @endif
                    </dl>
            </details>
