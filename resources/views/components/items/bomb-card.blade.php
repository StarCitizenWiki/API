        ...
        @if ($hasSecondary)
            <details class="group" open>
                <summary class="flex cursor-pointer items-center gap-2 py-2 text-sm font-semibold text-base-content/70 list-none [&::-webkit-details-marker]:hidden">
                    ...
                    <!-- Timing Parameters -->
                    @if ($hasTimingData)
                        <h4 class="text-xs font-medium uppercase tracking-wide text-base-content/45 mb-2">Timing</h4>
                        <dl class="grid gap-3 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 mb-4 pt-1 pb-2">
                            ...
                            @if ($maximumDropAngle !== null)
                                <div class="space-y-1">
                                    <dt class="text-xs font-medium uppercase tracking-wide text-base-content/45">Maximum Drop Angle</dt>
