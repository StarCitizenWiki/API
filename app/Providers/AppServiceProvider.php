...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
         ...
         */
        $this->app->bind('StarCitizen\API\StatsRepository', \App\Repositories\StarCitizen\APIv1\Stats\StatsInterface::class);

        /**
         * Star Citizen Wiki API Interfaces
         */
        $this->app->bind('StarCitizenWiki\API\ShipsRepository', \App\Repositories\StarCitizenWiki\APIv1\Ships\ShipsInterface::class);
