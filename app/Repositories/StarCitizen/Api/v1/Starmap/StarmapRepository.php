...
class StarmapRepository extends AbstractBaseRepository implements StarmapRepositoryInterface
{
     ...
     *
     * @return \App\Repositories\StarCitizen\Api\v1\StarmapRepository
    ...
    {
        app('Log')::debug(make_name_readable(__FUNCTION__), ['system' => $systemName]);
    ...
    {
        app('Log')::debug(make_name_readable(__FUNCTION__), ['objectName' => $objectName]);
    ...
    {
        app('Log')::debug(make_name_readable(__FUNCTION__), ['searchString' => $searchString]);
