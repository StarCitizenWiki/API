    ...
    protected static function boot(): void
    {
        ...
        static::addGlobalScope(
            ...
            //                    ->where('sc_items.name', '<>', '<= PLACEHOLDER =>')
                    ...
                    ->where('sc_items.class_name', 'NOT LIKE', '%mannequin%')
                    ->where('sc_items.class_name', 'NOT LIKE', '%ai\_exclusive%')
                    ->where('sc_items.class_name', 'NOT LIKE', 'animated%')
                    ->where('sc_items.class_name', 'NOT LIKE', '%\_piercing')
                    ->where('sc_items.class_name', 'NOT LIKE', '%\_dmg\_%')
                    ->where('sc_items.class_name', 'NOT LIKE', '%\_default\_%')
                    ->where('sc_items.class_name', 'NOT LIKE', '%\_ai')
                    ...
                    ->where('sc_items.class_name', 'NOT LIKE', '%\_tiesim\_%')
                    ->where('sc_items.class_name', 'NOT LIKE', '%\_nes')
                    ->where('sc_items.class_name', 'NOT LIKE', '%\_logoless')
                    ->where('sc_items.class_name', 'NOT LIKE', '%\_nodecal')
                    ->where('sc_items.class_name', 'NOT LIKE', '%\_scientist')
                    ->where('sc_items.class_name', 'NOT LIKE', '%\_refinery\_%')
                    ->where('sc_items.class_name', 'NOT LIKE', '%\_doctor\_%')
                    ->where('sc_items.class_name', 'NOT LIKE', '%\_nvy01%') // Temp?
                    ->where('sc_items.class_name', 'NOT LIKE', '%\_greeter')
                    ->where('sc_items.class_name', 'NOT LIKE', '%\_drak_cutlass_steel')
                    ->where('sc_items.class_name', 'NOT LIKE', '%\_fakehologram')
                    ->where('sc_items.class_name', 'NOT LIKE', '%\_l')
                    ->where('sc_items.class_name', '<>', 'grin\_tool\_01\_mag');
            }
        );
    }
