    ...
    allOf: [
        new OA\Schema(
            properties: [
                ...
                new OA\Property(property: 'web_url', description: 'Web URL for the vehicle detail page.', type: 'string', nullable: true),
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'link' => $vehicleData->vehicle
                ? $this->urlWithVersion(route('vehicles.show', ['vehicle' => $vehicleData->vehicle->uuid]), $request)
                : null,
            'web_url' => $vehicleData->vehicle
                ? $this->urlWithVersion(route('web.vehicles.show', ['vehicle' => $vehicleData->vehicle->slug ?? $vehicleData->vehicle->uuid]), $request)
                : null,
