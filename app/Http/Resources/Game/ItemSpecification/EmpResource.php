...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(
            ...
            description: 'Deprecated: use charge_time. Kept for backward compatibility with v2 naming.',
            type: 'double',
            example: 12.0,
            nullable: true,
            deprecated: true
        ...
        new OA\Property(
            ...
            description: 'Deprecated: use unleash_time. Kept for backward compatibility with v2 naming.',
            type: 'double',
            example: 0.75,
            nullable: true,
            deprecated: true
        ...
        new OA\Property(
            ...
            description: 'Deprecated: use cooldown_time. Kept for backward compatibility with v2 naming.',
            type: 'double',
            example: 6.0,
            nullable: true,
            deprecated: true
...
class EmpResource extends AbstractItemSpecificationResource
{
    public function toArray(Request $request): array
    {
        ...
        return [
            'charge_time' => Arr::get($emp, 'ChargeTime'),
            'unleash_time' => Arr::get($emp, 'UnleashTime'),
            'cooldown_time' => Arr::get($emp, 'CooldownTime'),
            'distortion_damage' => Arr::get($emp, 'DistortionDamage'),
            'emp_radius' => Arr::get($emp, 'EmpRadius'),
            'min_emp_radius' => Arr::get($emp, 'MinEmpRadius'),
            // Backward-compatible aliases (v2 naming)
