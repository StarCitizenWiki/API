...
#[OA\Schema(
    ...
    description: 'Gameplay-facing interdiction and jamming stats sourced from stdItem.QuantumInterdictionGenerator in the game data. Does not include RAW/engineering fields.',
    properties: [
        new OA\Property(
