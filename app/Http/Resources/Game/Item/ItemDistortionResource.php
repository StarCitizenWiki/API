...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'warning_ratio', description: 'Ratio of max at which a distortion warning indicator triggers (e.g. 0.75 = warning at 75%).', type: 'double', nullable: true, x: ['tabulator-formatter' => 'progress']),
        new OA\Property(property: 'recovery_ratio', description: 'Threshold below which distortion must fall before the item reactivates after overload. 0 = immediate recovery.', type: 'double', nullable: true, x: ['tabulator-formatter' => 'progress']),
