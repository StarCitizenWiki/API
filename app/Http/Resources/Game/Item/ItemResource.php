...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'manufacturer_description', description: 'Manufacturer name extracted from the description data entries.', type: 'string', nullable: true),
        new OA\Property(property: 'manufacturer', ref: '#/components/schemas/manufacturer_link', nullable: true),

        new OA\Property(property: 'type', description: 'Item type identifier (NOITEM_ prefix removed), e.g. Weapon, Armor, Clothing.', type: 'string', nullable: true),
        ...
        new OA\Property(property: 'sub_type', description: 'Item sub-type identifier, e.g. Small, Medium, Rocket.', type: 'string', nullable: true),
        ...
        new OA\Property(
            ...
            items: new OA\Items(
                properties: [
                    new OA\Property(property: 'uuid', description: 'Unique identifier of the entity tag.', type: 'string'),
                    new OA\Property(property: 'name', description: 'Name of the entity tag.', type: 'string'),
                ],
                type: 'object'
            ),
            nullable: true,
        ...
        new OA\Property(
            ...
            items: new OA\Items(
                properties: [
                    ...
                    new OA\Property(property: 'thumbnail_url', description: 'URL of the thumbnail image.', type: 'string', nullable: true),
                    new OA\Property(property: 'thumbnail_width', description: 'Thumbnail width in pixels.', type: 'integer', nullable: true),
                    new OA\Property(property: 'thumbnail_height', description: 'Thumbnail height in pixels.', type: 'integer', nullable: true),
                    new OA\Property(property: 'original_url', description: 'URL of the original full-size image.', type: 'string', nullable: true),
                    new OA\Property(property: 'original_width', description: 'Original image width in pixels.', type: 'integer', nullable: true),
                    new OA\Property(property: 'original_height', description: 'Original image height in pixels.', type: 'integer', nullable: true),
                ],
                type: 'object'
            ),
            nullable: true
...
#[OA\Schema(
    ...
    properties: [
        new OA\Property(property: 'uuid', description: 'Unique identifier of the blueprint.', type: 'string', format: 'uuid'),
        new OA\Property(property: 'name', description: 'Display name of the blueprint.', type: 'string'),
        new OA\Property(property: 'link', description: 'API URL for the blueprint detail endpoint.', type: 'string', format: 'uri'),
    ],
    type: 'object'
)]
#[OA\Schema(
    ...
    properties: [
        new OA\Property(property: 'uuid', description: 'Unique identifier of the related item.', type: 'string'),
        new OA\Property(property: 'name', description: 'Display name of the related item.', type: 'string'),
        new OA\Property(property: 'class_name', description: 'Internal class name of the related item.', type: 'string', nullable: true),
        new OA\Property(property: 'type', description: 'Item type identifier.', type: 'string', nullable: true),
        new OA\Property(property: 'type_label', description: 'Human-readable label for the item type', type: 'string', nullable: true),
        new OA\Property(property: 'sub_type', description: 'Item sub-type identifier.', type: 'string', nullable: true),
        new OA\Property(property: 'sub_type_label', description: 'Human-readable label for the item sub-type', type: 'string', nullable: true),
        new OA\Property(property: 'classification', description: 'Dot-separated classification path.', type: 'string', nullable: true),
        new OA\Property(property: 'classification_label', description: 'Human-readable label for the item classification', type: 'string', nullable: true),
        new OA\Property(property: 'is_base_variant', description: 'Whether this related item is the base variant.', type: 'boolean'),
        new OA\Property(property: 'variant_name', description: 'Variant name if this is a variant item.', type: 'string', nullable: true),
        new OA\Property(
        ...
        new OA\Property(property: 'version', description: 'Game version code.', type: 'string', nullable: true),
        new OA\Property(property: 'link', description: 'API URL for the related item.', type: 'string'),
        new OA\Property(property: 'web_url', description: 'Web URL for the related item.', type: 'string'),
        new OA\Property(property: 'size', description: 'Item size.', type: 'integer', nullable: true),
        new OA\Property(property: 'grade', description: 'Item grade.', type: 'integer', nullable: true),
        new OA\Property(property: 'grade_label', description: 'Grade (A/B/C/D for Ship items)', type: 'string', nullable: true),
        new OA\Property(property: 'class', description: 'Item class.', type: 'string', nullable: true),
    ],
    type: 'object'
)]
#[OA\Schema(
