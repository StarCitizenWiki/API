...
class CommLinkController extends Controller
{
    ...
    private const COMM_LINK_PERMISSION = 'web.rsi.comm-links.update';
    ...
    public function update(CommLinkRequest $request, CommLink $commLink): RedirectResponse
    {
        ...
        return redirect()->route('web.rsi.comm-links.show', $commLink->getRouteKey())->withMessages(
            [
                'success' => [
                    $message,
                ],
    ...
    {
        $this->authorize('web.rsi.comm-links.preview');
