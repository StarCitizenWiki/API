...
namespace App\Http\Controllers\Web\StarCitizen\Vehicle\Ship;
...
class ShipController extends Controller
{
    ...
    {
        return view(
            'web.starcitizen.vehicles.ships.index',
            [
                'ships' => Ship::all(),
            ]
        );
    ...
    public function edit(Ship $ship): View
    {
        ...
        return view(
            'web.starcitizen.vehicles.ships.edit',
            [
                'ship' => $ship,
    ...
    public function update(TranslationRequest $request, Ship $ship): RedirectResponse
    {
        ...
        return redirect()->route('web.starcitizen.vehicles.ships.edit', $ship->getRouteKey())->withMessages(
            [
                'success' => [
