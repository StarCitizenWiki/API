...
namespace App\Http\Controllers\Web\StarCitizen\Vehicle\Type;
...
class TypeController extends Controller
{
    ...
    public function index(): View
    {
        ...
        return view(
            'web.starcitizen.vehicles.types.index',
            [
                'translations' => Type::all(),
                'languages' => Language::all(),
                'editRoute' => 'web.starcitizen.vehicles.types.edit',
            ]
        );
    }
    ...
    public function edit(Type $type): View
    {
        ...
        return view(
            ...
            [
                'translation' => $type,
                'updateRoute' => 'web.starcitizen.vehicles.types.update',
            ]
        );
    }
    ...
    public function update(TranslationRequest $request, Type $type): RedirectResponse
    {
        ...
        return redirect()->route('web.starcitizen.vehicles.types.index')->withMessages(
            [
                'success' => [
