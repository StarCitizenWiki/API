...
namespace App\Http\Controllers\Web\StarCitizen\Galactapedia;
...
class GalactapediaController extends Controller
{
    ...
    {
        return view(
            'web.starcitizen.galactapedia.index',
            [
        ...
        return view(
            ...
            [
                ...
                'wikitext' => (new CreateGalactapediaWikiPage($article, ''))
                    ->getFormattedText(
                        Article::normalizeContent($article->german()->translation ?? $article->english()->translation),
                        null
                    ),
