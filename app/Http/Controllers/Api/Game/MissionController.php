...
class MissionController extends Controller
{
    ...
    #[OA\Get(
        ...
        parameters: [
            ...
            new OA\Parameter(name: 'filter[mission_giver]', description: 'Exact match on the mission giver NPC name. Example: `Citizens for Prosperity`', in: 'query', schema: new OA\Schema(type: 'string')),
            new OA\Parameter(name: 'filter[faction]', description: 'Filter by faction name. Accepts comma-separated values. Example: `Headhunters`', in: 'query', schema: new OA\Schema(type: 'string')),
            new OA\Parameter(name: 'filter[star_system]', description: 'Filter by star system name. Example: `Stanton`', in: 'query', schema: new OA\Schema(type: 'string')),
            new OA\Parameter(name: 'filter[illegal]', description: 'Filter for missions marked as illegal. Example: `true`', in: 'query', schema: new OA\Schema(type: 'boolean')),
            new OA\Parameter(name: 'filter[shareable]', description: 'Filter for shareable missions. Example: `true`', in: 'query', schema: new OA\Schema(type: 'boolean')),
            new OA\Parameter(name: 'filter[once_only]', description: 'Filter for one-time-only missions. Example: `true`', in: 'query', schema: new OA\Schema(type: 'boolean')),
            new OA\Parameter(name: 'filter[available_in_prison]', description: 'Filter for missions available while in prison. Example: `true`', in: 'query', schema: new OA\Schema(type: 'boolean')),
            new OA\Parameter(name: 'filter[has_combat]', description: 'Filter for missions involving combat encounters. Example: `true`', in: 'query', schema: new OA\Schema(type: 'boolean')),
            new OA\Parameter(name: 'filter[has_defend_objective]', description: 'Filter for missions with a defend objective. Example: `true`', in: 'query', schema: new OA\Schema(type: 'boolean')),
            new OA\Parameter(name: 'filter[rank_index]', description: 'Filter by mission difficulty rank. Example: `1`', in: 'query', schema: new OA\Schema(type: 'integer')),
            new OA\Parameter(name: 'filter[has_prerequisites]', description: 'Filter for missions that have prerequisite requirements. Example: `true`', in: 'query', schema: new OA\Schema(type: 'boolean')),
            new OA\Parameter(name: 'filter[min_enemies]', description: 'Minimum enemy count threshold. Example: `3`', in: 'query', schema: new OA\Schema(type: 'integer')),
            new OA\Parameter(name: 'filter[max_enemies]', description: 'Maximum enemy count threshold. Example: `10`', in: 'query', schema: new OA\Schema(type: 'integer')),
            new OA\Parameter(name: 'filter[reward_min]', description: 'Minimum reward in aUEC. Example: `5000`', in: 'query', schema: new OA\Schema(type: 'integer')),
            new OA\Parameter(name: 'filter[reward_max]', description: 'Maximum reward in aUEC. Example: `50000`', in: 'query', schema: new OA\Schema(type: 'integer')),
            new OA\Parameter(name: 'filter[title]', description: 'Partial match on mission title. Example: `Delivery`', in: 'query', schema: new OA\Schema(type: 'string')),
            new OA\Parameter(name: 'filter[description]', description: 'Partial match on mission description. Example: `combat`', in: 'query', schema: new OA\Schema(type: 'string')),
            new OA\Parameter(
                name: 'filter[query]',
            ...
            new OA\Parameter(name: 'filter[reward_scope]', description: 'Mission category scope. Example: `Bounty Hunter`', in: 'query', schema: new OA\Schema(type: 'string')),
            new OA\Parameter(name: 'filter[has_blueprints]', description: 'Filter for missions that reward blueprints. Example: `true`', in: 'query', schema: new OA\Schema(type: 'boolean')),
