...
class VehicleController extends Controller
{
    ...
    #[OA\Get(
        ...
        parameters: [
            ...
            new OA\Parameter(name: 'filter[manufacturer]', description: 'Manufacturer name or code. Accepts comma-separated values for OR matching. (see GET /api/vehicles/filters for valid values)', in: 'query', schema: new OA\Schema(type: 'string', example: 'Tumbril')),
            ...
            new OA\Parameter(name: 'filter[role]', description: 'Partial match on vehicle role. (see GET /api/vehicles/filters for valid values)', in: 'query', schema: new OA\Schema(type: 'string', example: 'Starter / Light Freight')),
            new OA\Parameter(name: 'filter[is_vehicle]', description: 'Filter to ground vehicles only.', in: 'query', schema: new OA\Schema(type: 'boolean', example: true)),
            new OA\Parameter(name: 'filter[is_gravlev]', description: 'Filter to gravlev vehicles only.', in: 'query', schema: new OA\Schema(type: 'boolean', example: true)),
            new OA\Parameter(name: 'filter[is_spaceship]', description: 'Filter to spaceships only.', in: 'query', schema: new OA\Schema(type: 'boolean', example: true)),
            new OA\Parameter(name: 'filter[mass_total]', description: 'Numeric filter on total mass (kg). Supports range operators.', in: 'query', schema: new OA\Schema(type: 'number', example: 50000)),
            new OA\Parameter(name: 'filter[cargo_capacity]', description: 'Numeric filter on cargo capacity (SCU). Supports range operators.', in: 'query', schema: new OA\Schema(type: 'number', example: 46)),
            new OA\Parameter(name: 'filter[vehicle_inventory]', description: 'Numeric filter on vehicle inventory/stowage capacity. Supports range operators.', in: 'query', schema: new OA\Schema(type: 'number', example: 432)),
            new OA\Parameter(name: 'filter[crew.min]', description: 'Numeric filter on minimum crew count. Supports range operators.', in: 'query', schema: new OA\Schema(type: 'integer', example: 2)),
            new OA\Parameter(name: 'filter[health]', description: 'Numeric filter on vehicle health points. Supports range operators.', in: 'query', schema: new OA\Schema(type: 'number', example: 50000)),
            new OA\Parameter(name: 'filter[shield.hp]', description: 'Numeric filter on total shield hit points. Supports range operators.', in: 'query', schema: new OA\Schema(type: 'number', example: 1000000)),
            new OA\Parameter(name: 'filter[shield.face_type]', description: 'Shield face type. (see GET /api/vehicles/filters for valid values)', in: 'query', schema: new OA\Schema(type: 'string', example: 'Bubble')),
            new OA\Parameter(name: 'filter[speed.scm]', description: 'Numeric filter on SCM speed. Supports range operators.', in: 'query', schema: new OA\Schema(type: 'number', example: 200)),
            new OA\Parameter(name: 'filter[speed.max]', description: 'Numeric filter on maximum speed. Supports range operators.', in: 'query', schema: new OA\Schema(type: 'number', example: 1200)),
            new OA\Parameter(name: 'filter[armor.health]', description: 'Numeric filter on armor health points. Supports range operators.', in: 'query', schema: new OA\Schema(type: 'number', example: 500000)),
            new OA\Parameter(name: 'filter[cross section.length]', description: 'Numeric filter on cross-section length (X axis). Supports range operators.', in: 'query', schema: new OA\Schema(type: 'number', example: 100)),
            new OA\Parameter(name: 'filter[cross section.width]', description: 'Numeric filter on cross-section width (Y axis). Supports range operators.', in: 'query', schema: new OA\Schema(type: 'number', example: 50)),
            new OA\Parameter(name: 'filter[cross section.height]', description: 'Numeric filter on cross-section height (Z axis). Supports range operators.', in: 'query', schema: new OA\Schema(type: 'number', example: 30)),
            new OA\Parameter(name: 'filter[signature.ir_quantum]', description: 'Numeric filter on infrared quantum signature emission. Supports range operators.', in: 'query', schema: new OA\Schema(type: 'number', example: 100)),
            new OA\Parameter(name: 'filter[signature.ir_shields]', description: 'Numeric filter on infrared shield signature emission. Supports range operators.', in: 'query', schema: new OA\Schema(type: 'number', example: 100)),
            new OA\Parameter(name: 'filter[signature.em_quantum]', description: 'Numeric filter on electromagnetic quantum signature emission. Supports range operators.', in: 'query', schema: new OA\Schema(type: 'number', example: 100)),
            new OA\Parameter(name: 'filter[signature.em_shields]', description: 'Numeric filter on electromagnetic shield signature emission. Supports range operators.', in: 'query', schema: new OA\Schema(type: 'number', example: 100)),
        ],
        responses: [
    ...
    #[OA\Get(
        ...
        parameters: [
            ...
            new OA\Parameter(name: 'filter[manufacturer]', description: 'Manufacturer name or code. Accepts comma-separated values for OR matching. (see GET /api/vehicles/filters for valid values)', in: 'query', schema: new OA\Schema(type: 'string', example: 'Drake')),
    ...
    #[OA\Get(
        ...
        parameters: [
            ...
            new OA\Parameter(name: 'filter[manufacturer]', description: 'Manufacturer name or code. Accepts comma-separated values for OR matching. (see GET /api/vehicles/filters for valid values)', in: 'query', schema: new OA\Schema(type: 'string', example: 'Aegis Dynamics')),
            new OA\Parameter(name: 'filter[manufacturer.name]', description: 'Alias for filter[manufacturer].', in: 'query', schema: new OA\Schema(type: 'string', example: 'Anvil Aerospace')),
            new OA\Parameter(name: 'filter[class_name]', description: 'Partial match on vehicle class name.', in: 'query', schema: new OA\Schema(type: 'string', example: 'NOBI')),
            new OA\Parameter(name: 'filter[name]', description: 'Partial match on vehicle display name.', in: 'query', schema: new OA\Schema(type: 'string', example: 'Nova')),
            new OA\Parameter(
                ...
                in: 'query',
                schema: new OA\Schema(type: 'string', example: 'Carrack'),
                examples: [
                    new OA\Examples(example: 'search_carrack', summary: 'Find the Carrack', value: 'carrack'),
                    new OA\Examples(example: 'search_arrow', summary: 'Find the Arrow', value: 'arrow'),
                ],
            ),
            new OA\Parameter(name: 'filter[size]', description: 'Exact match on vehicle size (1-6).', in: 'query', schema: new OA\Schema(type: 'integer', example: 3)),
            new OA\Parameter(name: 'filter[size_class]', description: 'Alias for filter[size].', in: 'query', schema: new OA\Schema(type: 'integer', example: 3)),
    ...
    #[OA\Get(
        ...
        tags: ['Vehicles'],
        parameters: [
            new OA\Parameter(name: 'identifier', in: 'path', required: true, schema: new OA\Schema(description: 'Vehicle name, class_name, or UUID', type: 'string', example: 'Nova')),
            new OA\Parameter(ref: '#/components/parameters/include'),
            new OA\Parameter(ref: '#/components/parameters/version'),
        ],
        responses: [
    ...
    #[OA\Get(
        ...
        tags: ['Vehicles'],
        parameters: [
            new OA\Parameter(name: 'identifier', in: 'path', required: true, schema: new OA\Schema(description: 'Vehicle name, class_name, or UUID', type: 'string', example: 'Dragonfly')),
            new OA\Parameter(ref: '#/components/parameters/include'),
            new OA\Parameter(ref: '#/components/parameters/version'),
        ],
        responses: [
    ...
    #[OA\Get(
        ...
        parameters: [
            new OA\Parameter(
                ...
                examples: [
                    new OA\Examples(example: 'by_slug', summary: 'Lookup by slug', value: 'carrack'),
                    new OA\Examples(example: 'by_name', summary: 'Lookup by display name', value: 'Carrack'),
                ],
            ),
            new OA\Parameter(ref: '#/components/parameters/include'),
            new OA\Parameter(ref: '#/components/parameters/version'),
