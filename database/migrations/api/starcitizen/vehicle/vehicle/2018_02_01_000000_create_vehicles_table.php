    ...
    public function up()
    {
        Schema::create(
            ...
            function (Blueprint $table) {
                ...
                $table->string('pitch_max')->nullable();
                $table->string('yaw_max')->nullable();
                $table->string('roll_max')->nullable();
                $table->string('x_axis_acceleration')->nullable();
                $table->string('y_axis_acceleration')->nullable();
                $table->string('z_axis_acceleration')->nullable();
